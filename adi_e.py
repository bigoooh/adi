...
from keras.layers import Embedding,SimpleRNN,Masking,Input,Conv1D,Conv2D,Conv3D, BatchNormalization, MaxPooling1D,MaxPooling2D,AveragePooling2D,MaxPooling3D, Dense, Input, Dropout, Flatten,GRU,TimeDistributed,Bidirectional,LSTM,Input,concatenate,Activation,average,SpatialDropout1D
...
for t,v in kf.split(X_all):
    ...
    early_stoppig=keras.callbacks.EarlyStopping(monitor='val_acc', min_delta=0, patience=10, verbose=0, mode='auto')
